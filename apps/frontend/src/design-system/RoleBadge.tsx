...
const ROLE = {
  // student = turquoise + academic cap · teacher = indigo + board ·
  // parent = olive-green + shield. Faint rgba washes only — badges never
  // redefine the product palette.
  ...
  parent: { label: 'הורה (Parent)', tint: 'rgba(128, 150, 60, 0.18)', fg: 'rgba(174, 196, 110, 1)', Icon: ShieldCheck },
